...
import com.example.saloonify.databinding.ActivityEnquireHomeBinding
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase


class UserEnquiryHome : AppCompatActivity(){
    ...
    private lateinit var binding : ActivityEnquireHomeBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityEnquireHomeBinding.inflate(layoutInflater)
